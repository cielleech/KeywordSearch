...
namespace KeyWordSerch.Data
{
    ...
    {
        public static readonly string connectionString = System.Configuration.ConfigurationManager.ConnectionStrings["KeyWordSerch.Properties.Settings.SerchItemsConnectionString"].ConnectionString;
        ...
        public static object ExecuteScalar(string cmdText, params OleDbParameter[] paraslist)
        {
            return ExecuteScalar(connectionString, CommandType.Text, cmdText, paraslist);
        }
        ...
        /// <summary>
        /// Execute a OleDbCommand that returns the count from the database specified in the connection string 
        /// using the provided parameters.
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        /// <param name="commandParameters">an array of SqlParamters used to execute the command</param>
        /// <returns>An object that should be converted to the expected type using Convert.To{Type}</returns>
        public static int ExecuteCount(string connectionString, CommandType cmdType, string cmdText, params OleDbParameter[] commandParameters)
        {
            OleDbCommand cmd = new OleDbCommand();
        ...
        /// <summary>
        /// Execute a OleDbCommand that returns the DataSet from the database specified in the connection string 
        /// using the provided parameters.
        /// </summary>
        /// <remarks>
        /// e.g.:  
        ...
        /// <summary>
        /// Execute a OleDbCommand that returns the DataTable from the database specified in the connection string 
        /// using the provided parameters.
        /// </summary>
        /// <remarks>
        /// e.g.:  
